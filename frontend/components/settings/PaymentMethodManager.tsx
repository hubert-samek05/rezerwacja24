  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-xl font-bold text-[var(--text-primary)] mb-1">Metody płatności</h3>
      ...
      <div className="space-y-4">
        <button
          ...
          disabled={loading}
          className="w-full bg-primary-green hover:bg-primary-green/80 text-[var(--text-primary)] font-semibold py-3 px-4 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
