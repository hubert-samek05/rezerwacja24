    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-[var(--text-primary)]">Godziny pracy</h3>
          </div>
          <button
            onClick={handleSave}
            disabled={saving}
              ...
              >
                <div className="flex items-center gap-4">
                  <label className="flex items-center gap-2 cursor-pointer min-w-[140px]">
                    ...
                    />
                    <span className={`font-medium ${dayData.enabled ? 'text-[var(--text-primary)]' : 'text-neutral-gray'}`}>
                      {label}
                    </span>
                  </label>
                    ...
                    <div className="flex items-center gap-3 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-[var(--text-primary)] focus:outline-none focus:border-accent-neon"
                        />
                      </div>
                      <div className="flex items-center gap-2">
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-bold text-[var(--text-primary)]">Urlopy i dni wolne</h3>
        </div>
          ...
          <div className="glass-card p-4">
            <div className="flex items-center gap-3">
              <input
                ...
                className="flex-1 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-[var(--text-primary)] focus:outline-none focus:border-accent-neon"
              />
              <button
                onClick={addTimeOff}
                className="btn-neon flex items-center gap-2"
