          ...
          <div className="p-8">
            ...
            <div className="bg-gradient-to-r from-[#41FFBC]/10 to-[#41FFBC]/5 rounded-xl p-6 mb-6 border border-[#41FFBC]/20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[var(--text-muted)] mb-1">Po okresie próbnym</p>
                  <p className="text-3xl font-bold text-[var(--text-primary)]">79,99 zł<span className="text-lg text-[var(--text-muted)]">/miesiąc</span></p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-[#41FFBC] font-semibold">7 DNI GRATIS</p>
                  <p className="text-xs text-[var(--text-muted)]">Karta nie zostanie obciążona</p>
                </div>
              </div>
            </div>
