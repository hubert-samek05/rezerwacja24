          ...
          <div className="p-8">
            ...
            >
              <div className="flex items-baseline justify-center gap-2 mb-2">
                ...
                <span className="text-xl text-gray-300">/miesiąc</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                onClick={onClose}
                className="sm:w-auto px-6 py-4 rounded-xl bg-white/10 hover:bg-white/20 text-white font-semibold transition-colors"
              >
                Później
              </button>
            </div>
