    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-950/80 via-teal-900/60 to-teal-900/40"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <p className="text-xl text-teal-100 mb-8">Profesjonalne zarządzanie rezerwacjami dla masażystów, fizjoterapeutów i gabinetów odnowy biologicznej</p>
