    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex items-center gap-8">
              <Link href="#funkcje" className="text-sm font-medium text-gray-600 hover:text-cyan-700 transition-colors">Funkcje</Link>
              <Link href="#jak-to-dziala" className="text-sm font-medium text-gray-600 hover:text-cyan-700 transition-colors">Jak to działa</Link>
              <Link href="#cennik" className="text-sm font-medium text-gray-600 hover:text-cyan-700 transition-colors">Cennik</Link>
              <Link href="/contact" className="text-sm font-medium text-gray-600 hover:text-cyan-700 transition-colors">Kontakt</Link>
            </div>
            
            <div className="hidden lg:flex items-center gap-4">
              <a href={`${appUrl}/login`} className="text-sm font-medium text-gray-600 hover:text-cyan-700 transition-colors">
                Zaloguj się
              </a>
              <a href={`${appUrl}/register`} className="px-5 py-2.5 bg-cyan-600 hover:bg-cyan-700 text-white font-medium rounded-lg transition-colors text-sm">
                Wypróbuj za darmo
              </a>
            </div>
                ...
                <div className="pt-20 px-8">
                  <nav className="space-y-1">
                    <Link 
                      href="#funkcje" 
                      onClick={() => setMobileMenuOpen(false)} 
                      className="block py-4 text-lg text-gray-700 hover:text-cyan-700 font-medium text-center"
                    >
                      Funkcje
                    </Link>
                    <Link 
                  ...
                  <div className="mt-10 space-y-3">
                    ...
                    <a 
                      ...
                      className="block w-full py-3.5 text-center text-white bg-cyan-600 hover:bg-cyan-700 font-medium rounded-lg"
                    >
                      Wypróbuj za darmo
                    </a>
                  </div>
      ...
      <section className="relative min-h-[100svh] flex items-center">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?auto=format&fit=crop&w=2091&q=80')" }}
        />
        {/* Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-950/90 via-cyan-900/80 to-cyan-800/60"></div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-24 pb-20 sm:pt-28 sm:pb-16">
          <div className="max-w-3xl">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-800/60 backdrop-blur-sm border border-cyan-300/30 rounded-full mb-6">
                <Stethoscope className="w-4 h-4 text-cyan-200" />
                <span className="text-sm text-white font-medium">System rezerwacji dla gabinetów medycznych</span>
              </div>
              
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-tight mb-5 sm:mb-6">
                Twój gabinet
                <span className="block text-cyan-200 mt-1 sm:mt-2">zawsze pełny pacjentów</span>
              </h1>
              
              <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto sm:mx-0">
                Rezerwacje online 24/7 dla gabinetów lekarskich, stomatologicznych i specjalistycznych. 
                Pacjenci umawiają się sami, Ty skupiasz się na leczeniu.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-12">
                <a 
                  href={`${appUrl}/register`} 
                  className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 bg-white text-cyan-700 font-semibold rounded-lg hover:bg-cyan-50 transition-colors text-base sm:text-lg"
                >
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-6 text-sm sm:text-base text-white/80 justify-center sm:justify-start">
                <div className="flex items-center justify-center sm:justify-start gap-2">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-200" />
      ...
      <section className="py-12 sm:py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 lg:gap-16">
            {[
              { value: '250+', label: 'gabinetów medycznych' },
              { value: '35k+', label: 'rezerwacji' },
              ...
              >
                <span className="text-3xl sm:text-4xl lg:text-5xl font-bold text-cyan-600">{stat.value}</span>
      ...
      <section className="py-24 bg-gradient-to-b from-cyan-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1.5 bg-cyan-100 text-cyan-800 text-sm font-semibold rounded-full mb-4">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Niezależnie czy prowadzisz gabinet lekarski, stomatologiczny czy specjalistyczny - nasz system jest stworzony dla Ciebie.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-12">
            {[
              { icon: Stethoscope, name: 'Gabinety lekarskie' },
              { icon: Heart, name: 'Stomatologia' },
              { icon: Activity, name: 'Diagnostyka' },
              { icon: UserCheck, name: 'Specjaliści' },
              { icon: Heart, name: 'Kardiologia' },
              { icon: Stethoscope, name: 'Pediatria' },
              { icon: Activity, name: 'Ginekologia' },
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-4 bg-white rounded-xl border border-cyan-100 hover:border-cyan-300 hover:shadow-lg transition-all"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-cyan-500/20 to-cyan-300/20 rounded-3xl blur-2xl"></div>
                
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200 lg:translate-x-12">
                  <Image
                    src="/screenshots/dashboard-preview.png"
                    alt="Panel zarządzania gabinetem medycznym"
                    width={1536}
                    height={1024}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: Users, title: 'Baza pacjentów', description: 'Pełna historia wizyt, notatki medyczne i dane kontaktowe. Buduj relacje z pacjentami.' },
              ...
              { icon: BarChart3, title: 'Raporty i analityka', description: 'Śledź przychody, popularność usług i efektywność lekarzy.' },
              { icon: CreditCard, title: 'Płatności online', description: 'Przyjmuj przedpłaty i płatności online. Bezpiecznie i wygodnie.' },
              { icon: Package, title: 'Pakiety usług', description: 'Twórz pakiety badań i karnety. Zwiększ lojalność pacjentów.' },
              { icon: Gift, title: 'Promocje i rabaty', description: 'Twórz promocje sezonowe i rabaty dla stałych pacjentów.' },
              { icon: Shield, title: 'Bezpieczeństwo RODO', description: 'Dane Twoich pacjentów są bezpieczne. Pełna zgodność z RODO.' },
            ].map((feature: any, i) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.03 }}
                  className="group p-6 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 bg-white border border-gray-100 hover:border-cyan-300"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors duration-300 bg-cyan-100 group-hover:bg-cyan-600">
                      <IconComponent className="w-6 h-6 transition-colors duration-300 text-cyan-700 group-hover:text-white" />
                    </div>
                    <div>
          ...
          <div className="mt-14 text-center">
            <a 
              href={`${appUrl}/register`}
              className="inline-flex items-center gap-2 px-8 py-4 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-cyan-600/20"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description: 'Pacjenci mogą rezerwować o każdej porze - nawet w nocy. Nie tracisz wizyt.',
                stat: '+30%',
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="group p-6 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-cyan-300"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-cyan-100 group-hover:bg-cyan-600 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors duration-300">
                      <IconComponent className="w-6 h-6 text-cyan-700 group-hover:text-white transition-colors duration-300" />
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="flex items-baseline gap-1.5">
                        <span className="text-2xl font-bold text-cyan-600">{benefit.stat}</span>
      ...
      <section id="jak-to-dziala" className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                num: '1',
                title: 'Załóż konto',
                description: 'Zarejestruj się za darmo i dodaj swoje usługi oraz lekarzy.',
                details: ['Rejestracja w 2 minuty', 'Dodaj usługi i ceny', 'Ustaw godziny przyjęć']
              },
              {
                num: '2',
              ...
              return (
                ...
                >
                  {i < 2 && (
                    <div className="hidden lg:block absolute top-16 left-full w-full h-0.5 bg-gradient-to-r from-cyan-200 to-transparent z-0" style={{width: 'calc(100% - 8rem)', left: 'calc(50% + 4rem)'}}></div>
                  )}
                  ...
                  <div className="relative bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                    <div className="absolute -top-4 left-8 px-3 py-1 bg-cyan-600 text-white text-sm font-bold rounded-full">
                      Krok {step.num}
                    </div>
                    
                    <div className="w-16 h-16 bg-cyan-100 rounded-2xl flex items-center justify-center mb-6 mt-2">
                      <StepIcon className="w-8 h-8 text-cyan-700" />
                    </div>
          ...
          <div className="text-center mt-16">
            <a 
              href={`${appUrl}/register`}
              className="inline-flex items-center gap-2 px-8 py-4 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-xl transition-all text-lg shadow-lg shadow-cyan-600/20"
            >
      ...
      {/* Testimonials */}
      <section className="py-24 bg-cyan-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: 'Od kiedy mam Rezerwacja24, nie muszę odbierać telefonów podczas przyjęć. Pacjenci umawiają się sami, a ja mam spokój.',
                author: 'Dr Anna Kowalska',
                role: 'Gabinet stomatologiczny'
              },
              {
                quote: 'Przypomnienia SMS to strzał w dziesiątkę! Praktycznie nie mam już pustych terminów. Polecam każdemu lekarzowi.',
                author: 'Dr Marek Nowak',
                role: 'Gabinet internistyczny'
              },
              {
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="bg-cyan-600/80 backdrop-blur rounded-2xl p-8 border border-cyan-500/50"
              >
                ...
                <div>
                  ...
                  <p className="text-cyan-200">{item.role}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mb-4">Dla małych gabinetów</p>
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold text-gray-900">12,99</span>
                  <span className="text-gray-500">zł/mies.</span>
                </div>
                <p className="text-sm text-cyan-600 mt-2 font-medium">7 dni za darmo</p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-600 flex-shrink-0" />
                  <span className="text-gray-700">1 lekarz</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-600 flex-shrink-0" />
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-600 flex-shrink-0" />
                  <span className="text-gray-700 font-medium">Zgodność z RODO</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 border-2 border-cyan-500 relative transform md:scale-105 z-10">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                <span className="px-4 py-1 bg-cyan-600 text-white text-sm font-bold rounded-full">
                  Najpopularniejszy
                </span>
              </div>
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold text-cyan-600">29,99</span>
                  <span className="text-gray-500">zł/mies.</span>
                </div>
                <p className="text-sm text-cyan-600 mt-2 font-medium">7 dni za darmo</p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-600 flex-shrink-0" />
                  <span className="text-gray-700">Do 5 lekarzy</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-600 flex-shrink-0" />
              ...
              <a 
                ...
                className="block w-full py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-xl text-center transition-colors"
              >
                Rozpocznij za darmo
              </a>
            </div>
            ...
            <div className="bg-gray-900 rounded-2xl shadow-lg p-6 lg:p-8">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-400 mb-4">Dla dużych klinik</p>
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold text-white">79,99</span>
                  <span className="text-gray-400">zł/mies.</span>
                </div>
                <p className="text-sm text-cyan-400 mt-2 font-medium">7 dni za darmo</p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0" />
                  <span className="text-white font-medium">Bez limitu lekarzy</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0" />
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0" />
                  <span className="text-white font-medium">Zgodność z RODO</span>
                </div>
              </div>
      ...
      <section className="py-24 bg-cyan-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cyan-100 mb-10">
            Dołącz do setek gabinetów medycznych, które już korzystają z Rezerwacja24
          </p>
          <a 
            href={`${appUrl}/register`}
            className="inline-flex items-center gap-3 px-10 py-5 bg-white text-cyan-700 font-bold rounded-xl text-xl hover:bg-cyan-50 transition-colors"
          >
            Załóż konto za darmo
      ...
      <footer className="bg-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                System rezerwacji online dla gabinetów lekarskich i klinik medycznych.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">&copy; 2026 Rezerwacja24 - System rezerwacji dla gabinetów medycznych</p>
