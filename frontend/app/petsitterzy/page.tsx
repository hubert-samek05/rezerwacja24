...
const PawPrint = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 12c-2.5 0-4.5 2-4.5 4.5 0 2 1.5 3.5 4.5 3.5s4.5-1.5 4.5-3.5c0-2.5-2-4.5-4.5-4.5z"/>
  </svg>
)

export default function PetsitterzLandingPage() {
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex items-center gap-8">
              <Link href="#funkcje" className="text-sm font-medium text-gray-600 hover:text-amber-700 transition-colors">Funkcje</Link>
              <Link href="#jak-to-dziala" className="text-sm font-medium text-gray-600 hover:text-amber-700 transition-colors">Jak to działa</Link>
              <Link href="#cennik" className="text-sm font-medium text-gray-600 hover:text-amber-700 transition-colors">Cennik</Link>
              <Link href="/contact" className="text-sm font-medium text-gray-600 hover:text-amber-700 transition-colors">Kontakt</Link>
            </div>
            
            <div className="hidden lg:flex items-center gap-4">
              <a href={`${appUrl}/login`} className="text-sm font-medium text-gray-600 hover:text-amber-700 transition-colors">
                Zaloguj się
              </a>
              <a href={`${appUrl}/register`} className="px-5 py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-lg transition-colors text-sm">
                Wypróbuj za darmo
              </a>
            </div>
                ...
                <div className="pt-20 px-8">
                  <nav className="space-y-1">
                    <Link 
                      href="#funkcje" 
                      onClick={() => setMobileMenuOpen(false)} 
                      className="block py-4 text-lg text-gray-700 hover:text-amber-700 font-medium text-center"
                    >
                      Funkcje
                    </Link>
                    <Link 
                  ...
                  <div className="mt-10 space-y-3">
                    ...
                    <a 
                      ...
                      className="block w-full py-3.5 text-center text-white bg-amber-600 hover:bg-amber-700 font-medium rounded-lg"
                    >
                      Wypróbuj za darmo
                    </a>
                  </div>
      ...
      <section className="relative min-h-[100svh] flex items-center">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1587300003388-59208cc962cb?auto=format&fit=crop&w=2070&q=80')" }}
        />
        {/* Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-amber-900/90 via-amber-800/80 to-amber-700/60"></div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-24 pb-20 sm:pt-28 sm:pb-16">
          <div className="max-w-3xl">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-800/60 backdrop-blur-sm border border-amber-300/30 rounded-full mb-6">
                <Heart className="w-4 h-4 text-amber-200" />
                <span className="text-sm text-white font-medium">System rezerwacji dla opiekunów zwierząt</span>
              </div>
              
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-tight mb-5 sm:mb-6">
                Twój kalendarz
                <span className="block text-amber-200 mt-1 sm:mt-2">zawsze pełny pupili</span>
              </h1>
              
              <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto sm:mx-0">
                Rezerwacje online 24/7 dla petsitterów, groomerów i hoteli dla zwierząt. 
                Właściciele umawiają się sami, Ty skupiasz się na opiece nad pupilami.
              </p>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-6 text-sm sm:text-base text-white/80 justify-center sm:justify-start">
                <div className="flex items-center justify-center sm:justify-start gap-2">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-amber-200" />
      ...
      <section className="py-12 sm:py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 lg:gap-16">
            {[
              { value: '150+', label: 'opiekunów zwierząt' },
              { value: '20k+', label: 'rezerwacji' },
              ...
              >
                <span className="text-3xl sm:text-4xl lg:text-5xl font-bold text-amber-600">{stat.value}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Niezależnie czy jesteś petsitterem, groomerem czy prowadzisz hotel dla zwierząt - nasz system jest stworzony dla Ciebie.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-12">
            {[
              { icon: Heart, name: 'Petsitterzy' },
              { icon: Scissors, name: 'Salony groomerskie' },
              { icon: Home, name: 'Hotele dla zwierząt' },
              { icon: MapPin, name: 'Dog walkerzy' },
              { icon: Heart, name: 'Opieka nad kotami' },
              { icon: Star, name: 'Szkolenie psów' },
              { icon: Home, name: 'Przedszkola dla psów' },
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-4 bg-white rounded-xl border border-amber-100 hover:border-amber-300 hover:shadow-lg transition-all"
                >
      ...
      <section id="funkcje" className="py-24 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <span className="inline-block px-4 py-1.5 bg-amber-100 text-amber-800 text-sm font-semibold rounded-full mb-4">
                Funkcje dla opiekunów
              </span>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
                Wszystko czego potrzebujesz
              </h2>
              <p className="text-xl text-gray-600 mb-6">
                Kompleksowy system rezerwacji stworzony z myślą o opiece nad zwierzętami.
              </p>
              <ul className="space-y-3">
                {[
                  'Rezerwacje online 24/7 - właściciele umawiają się sami',
                  'Automatyczne przypomnienia SMS i email',
                  'Kalendarz dla wielu usług',
                  'Własna strona rezerwacyjna z Twoim logo',
                  'Baza klientów z historią wizyt i pupilami',
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200 lg:translate-x-12">
                  <Image
                    ...
                    alt="Panel zarządzania dla petsitterów"
                    width={1536}
                    height={1024}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: Users, title: 'Baza klientów i pupili', description: 'Pełna historia wizyt, informacje o zwierzętach i notatki. Buduj relacje z właścicielami.' },
              ...
              { icon: Package, title: 'Pakiety usług', description: 'Twórz pakiety spacerów i karnety. Zwiększ lojalność klientów.' },
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.03 }}
                  className="group p-6 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 bg-white border border-gray-100 hover:border-amber-300"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors duration-300 bg-amber-100 group-hover:bg-amber-600">
                      <IconComponent className="w-6 h-6 transition-colors duration-300 text-amber-700 group-hover:text-white" />
                    </div>
                    <div>
          ...
          <div className="mt-14 text-center">
            <a 
              href={`${appUrl}/register`}
              className="inline-flex items-center gap-2 px-8 py-4 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-amber-600/20"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Więcej czasu na pupile, mniej na administrację
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Koniec z odbieraniem telefonów i ręcznym zapisywaniem wizyt. Właściciele umawiają się sami.',
                stat: '5h',
              ...
              },
              {
                ...
                description: 'Właściciele mogą rezerwować o każdej porze - nawet w nocy. Nie tracisz rezerwacji.',
                stat: '+30%',
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="group p-6 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-amber-300"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-amber-100 group-hover:bg-amber-600 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors duration-300">
                      <IconComponent className="w-6 h-6 text-amber-700 group-hover:text-white transition-colors duration-300" />
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="flex items-baseline gap-1.5">
                        <span className="text-2xl font-bold text-amber-600">{benefit.stat}</span>
      ...
      <section id="jak-to-dziala" className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                num: '1',
                title: 'Załóż konto',
                description: 'Zarejestruj się za darmo i dodaj swoje usługi.',
                details: ['Rejestracja w 2 minuty', 'Dodaj usługi i ceny', 'Ustaw dostępność']
              },
              {
                num: '2',
                title: 'Udostępnij link',
                description: 'Podziel się linkiem do rezerwacji z właścicielami zwierząt.',
                details: ['Własna strona rezerwacji', 'Widget na Twoją stronę', 'Link do social media']
              },
              {
                num: '3',
                title: 'Przyjmuj rezerwacje',
                description: 'Właściciele rezerwują online, Ty dostajesz powiadomienia.',
              ...
              return (
                ...
                >
                  {i < 2 && (
                    <div className="hidden lg:block absolute top-16 left-full w-full h-0.5 bg-gradient-to-r from-amber-200 to-transparent z-0" style={{width: 'calc(100% - 8rem)', left: 'calc(50% + 4rem)'}}></div>
                  )}
                  ...
                  <div className="relative bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
                    <div className="absolute -top-4 left-8 px-3 py-1 bg-amber-600 text-white text-sm font-bold rounded-full">
                      Krok {step.num}
                    </div>
                    
                    <div className="w-16 h-16 bg-amber-100 rounded-2xl flex items-center justify-center mb-6 mt-2">
                      <StepIcon className="w-8 h-8 text-amber-700" />
                    </div>
          ...
          <div className="text-center mt-16">
            <a 
              href={`${appUrl}/register`}
              className="inline-flex items-center gap-2 px-8 py-4 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-xl transition-all text-lg shadow-lg shadow-amber-600/20"
            >
      ...
      <section className="py-24 bg-amber-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: 'Od kiedy mam Rezerwacja24, nie muszę odbierać telefonów podczas spacerów z psami. Właściciele umawiają się sami!',
                author: 'Kasia Kowalska',
                role: 'Petsitter "Happy Paws"'
              },
              {
                quote: 'Przypomnienia SMS to strzał w dziesiątkę! Praktycznie nie mam już pustych terminów. Polecam każdemu groomerowi.',
                author: 'Marta Nowak',
                role: 'Salon groomerski "Futrzak"'
              },
              {
                ...
                role: 'Hotel dla zwierząt "Raj Pupila"'
              },
            ].map((item, i) => (
              <motion.div 
                key={i}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-amber-200">{item.role}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="mb-6">
                ...
                <p className="text-sm text-amber-600 mt-2 font-medium">7 dni za darmo</p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-amber-600 flex-shrink-0" />
                  <span className="text-gray-700">1 opiekun</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-amber-600 flex-shrink-0" />
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 border-2 border-amber-500 relative transform md:scale-105 z-10">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold text-amber-600">29,99</span>
                  <span className="text-gray-500">zł/mies.</span>
                </div>
                <p className="text-sm text-amber-600 mt-2 font-medium">7 dni za darmo</p>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-amber-600 flex-shrink-0" />
                  <span className="text-gray-700">Do 5 opiekunów</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-amber-600 flex-shrink-0" />
              ...
              <a 
                ...
                className="block w-full py-3 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-xl text-center transition-colors"
              >
                Rozpocznij za darmo
              </a>
            </div>
            ...
            <div className="bg-gray-900 rounded-2xl shadow-lg p-6 lg:p-8">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-400 mb-4">Dla dużych firm</p>
                <div className="flex items-baseline gap-1">
      ...
      <section className="py-24 bg-amber-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Gotowy na więcej pupili?
          </h2>
          <p className="text-xl text-amber-100 mb-10">
            Dołącz do setek opiekunów zwierząt, którzy już korzystają z Rezerwacja24
          </p>
          <a 
            href={`${appUrl}/register`}
      ...
      <footer className="bg-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                System rezerwacji online dla petsitterów, groomerów i hoteli dla zwierząt.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/petsitterzy" className="hover:text-white transition-colors">Petsitterzy</Link></li>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">&copy; 2026 Rezerwacja24 - System rezerwacji dla opiekunów zwierząt</p>
