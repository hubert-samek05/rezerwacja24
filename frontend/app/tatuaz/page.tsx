      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-900/80 border border-teal-400/30 rounded-full mb-6">
      ...
      <section className="py-12 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            <div><p className="text-4xl font-bold text-teal-600 mb-1">90%</p><p className="text-gray-500">mniej nieobecności</p></div>
            <div><p className="text-4xl font-bold text-teal-600 mb-1">3h</p><p className="text-gray-500">oszczędności dziennie</p></div>
            <div><p className="text-4xl font-bold text-teal-600 mb-1">24/7</p><p className="text-gray-500">rezerwacje online</p></div>
            <div><p className="text-4xl font-bold text-teal-600 mb-1">150+</p><p className="text-gray-500">studiów tatuażu</p></div>
          </div>
        </div>
      </section>
