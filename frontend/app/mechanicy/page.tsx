          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/80 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto sm:mx-0">
                Rezerwacje online 24/7 dla warsztatów samochodowych, wulkanizacji i serwisów. 
                Klienci umawiają się sami, Ty skupiasz się na naprawach.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Idealny dla Twojego warsztatu
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Niezależnie czy prowadzisz warsztat samochodowy, wulkanizację czy serwis - nasz system jest stworzony dla Ciebie.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-12">
            {[
              { icon: Car, name: 'Warsztaty samochodowe' },
              { icon: Wrench, name: 'Serwisy mechaniczne' },
              { icon: Settings, name: 'Wulkanizacje' },
              { icon: Gauge, name: 'Stacje diagnostyczne' },
              { icon: Car, name: 'Myjnie samochodowe' },
              { icon: Wrench, name: 'Lakiernie' },
              { icon: Settings, name: 'Serwisy klimatyzacji' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
                Wszystko czego potrzebuje Twój warsztat
              </h2>
              <p className="text-xl text-gray-600 mb-6">
                Kompleksowy system rezerwacji stworzony z myślą o branży motoryzacyjnej.
              </p>
              <ul className="space-y-3">
                {[
                  'Rezerwacje online 24/7 - klienci umawiają się sami',
                  'Automatyczne przypomnienia SMS i email',
                  'Kalendarz dla wielu stanowisk',
                  'Własna strona rezerwacyjna z Twoim logo',
                  'Baza klientów z historią napraw',
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200 lg:translate-x-12">
                  <Image
                    ...
                    alt="Panel zarządzania warsztatem"
                    width={1536}
                    height={1024}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { icon: Calendar, title: 'Kalendarz online', description: 'Przejrzysty kalendarz z widokiem dnia, tygodnia i miesiąca. Zarządzaj zleceniami jednym kliknięciem.' },
              ...
              { icon: Users, title: 'Baza klientów', description: 'Pełna historia napraw, pojazdy i notatki. Buduj relacje z klientami.' },
              ...
              { icon: BarChart3, title: 'Raporty i analityka', description: 'Śledź przychody, popularność usług i efektywność stanowisk.' },
              { icon: CreditCard, title: 'Płatności online', description: 'Przyjmuj przedpłaty i płatności online. Bezpiecznie i wygodnie.' },
              { icon: Package, title: 'Pakiety usług', description: 'Twórz pakiety serwisowe i karnety. Zwiększ lojalność klientów.' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Więcej czasu na naprawy, mniej na administrację
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Koniec z odbieraniem telefonów i ręcznym zapisywaniem zleceń. Klienci umawiają się sami.',
                stat: '5h',
              ...
              },
              {
                ...
                description: 'Klienci mogą rezerwować o każdej porze - nawet w nocy. Nie tracisz zleceń.',
                stat: '+30%',
            ...
            {[
              {
                num: '1',
                title: 'Załóż konto',
                description: 'Zarejestruj się za darmo i dodaj swoje usługi oraz stanowiska.',
              ...
              return (
                ...
                >
                  {i < 2 && (
                    <div className="hidden lg:block absolute top-16 left-full w-full h-0.5 bg-gradient-to-r from-slate-200 to-transparent z-0" style={{width: 'calc(100% - 8rem)', left: 'calc(50% + 4rem)'}}></div>
                  )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
              Co mówią właściciele warsztatów?
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: 'Od kiedy mam Rezerwacja24, nie muszę odbierać telefonów pod samochodem. Klienci umawiają się sami, a ja mam spokój.',
                author: 'Tomasz Kowalski',
                role: 'Warsztat "Auto-Serwis"'
              },
              {
                quote: 'Przypomnienia SMS to strzał w dziesiątkę! Praktycznie nie mam już pustych terminów. Polecam każdemu warsztatowi.',
                author: 'Marek Nowak',
                role: 'Wulkanizacja "Opona Plus"'
              },
              {
                quote: 'Profesjonalna strona rezerwacji z moim logo robi wrażenie na klientach. Czuję się jak duża firma!',
                author: 'Piotr Wiśniewski',
                role: 'Serwis samochodowy "ProCar"'
              },
            ].map((item, i) => (
              <motion.div 
                key={i}
      ...
      <section id="cennik" className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Wybierz plan dla swojego warsztatu
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mb-4">Dla małych warsztatów</p>
            ...
            <div className="bg-gray-900 rounded-2xl shadow-lg p-6 lg:p-8">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-400 mb-4">Dla dużych warsztatów</p>
                <div className="flex items-baseline gap-1">
      ...
      <section className="py-24 bg-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-slate-300 mb-10">
            Dołącz do setek warsztatów, które już korzystają z Rezerwacja24
          </p>
          <a 
            href={`${appUrl}/register`}
      ...
      <footer className="bg-gray-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                System rezerwacji online dla warsztatów samochodowych i serwisów.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/mechanicy" className="hover:text-white transition-colors">Warsztaty samochodowe</Link></li>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">&copy; 2026 Rezerwacja24 - System rezerwacji dla warsztatów samochodowych</p>
