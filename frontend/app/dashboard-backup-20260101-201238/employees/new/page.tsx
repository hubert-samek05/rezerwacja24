    ...
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Dodaj pracownika</h1>
          <p className="text-neutral-gray/70 mt-2">Wypełnij poniższe informacje, aby dodać nowego członka zespołu</p>
        </div>
