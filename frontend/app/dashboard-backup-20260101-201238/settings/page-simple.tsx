          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3">
              ...
              {activeTab === 'company' && (
                ...
                >
                  <h2 className="text-2xl font-bold text-white mb-6">Dane firmy</h2>
              ...
              {activeTab === 'subdomain' && (
                ...
                >
                  <div className="glass-card p-6">
                    <h2 className="text-2xl font-bold text-white mb-6">Konfiguracja subdomeny</h2>
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className="flex-1 px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-accent-neon"
                          />
                  ...
                  <div className="glass-card p-6">
                    <h3 className="text-xl font-bold text-white mb-4">Podgląd profilu publicznego</h3>
                    <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                      <div className="flex items-center space-x-4 mb-4">
                        <div className="w-16 h-16 bg-gradient-accent rounded-full"></div>
                        <div>
                          <h4 className="text-xl font-bold text-white">{companyName}</h4>
              ...
              {activeTab === 'branding' && (
                <motion.div
                  ...
                  className="glass-card p-6"
                >
                  <h2 className="text-2xl font-bold text-white mb-6">Personalizacja brandingu</h2>
