    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-pink-950/80 via-pink-900/60 to-pink-900/40"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-pink-900/80 border border-pink-400/30 rounded-full mb-6">
              <Icon className="w-5 h-5 text-pink-300" />
              <span className="text-pink-300 font-medium">Dla salonów kosmetycznych</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {industryData.stats.map((stat, i) => (
              ...
              >
                <p className="text-4xl font-bold text-pink-600 mb-1">{stat.value}</p>
            ...
            {industryData.benefits.map((benefit, i) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="text-center p-6 bg-white rounded-2xl border border-gray-100 hover:border-pink-200 hover:shadow-lg transition-all"
                >
                  <div className="w-14 h-14 bg-pink-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <BenefitIcon className="w-7 h-7 text-pink-600" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/funkcje"
                className="mt-8 inline-flex items-center gap-2 text-pink-600 font-medium hover:text-pink-700"
              >
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-pink-500/10 to-rose-500/10 rounded-3xl blur-2xl"></div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {industryData.useCases.map((useCase, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.05 }}
                className="px-6 py-3 bg-pink-50 text-pink-700 rounded-full font-medium border border-pink-200"
              >
                {useCase}
              </motion.div>
            ))}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="text-left">
              ...
              <p className="text-pink-300">{industryData.testimonial.role}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-pink-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/register"
            className="inline-flex items-center gap-2 px-8 py-4 bg-pink-600 hover:bg-pink-700 text-white font-semibold rounded-xl transition-colors text-lg"
          >
