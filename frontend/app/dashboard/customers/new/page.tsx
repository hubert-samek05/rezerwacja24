      ...
      <main className="pt-16 p-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-2">Dodaj nowego klienta</h1>
            ...
            <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-lg text-[var(--text-primary)] placeholder-neutral-gray/50 focus:outline-none focus:border-accent-neon transition-colors"
                      placeholder="Jan"
                      required
                    />
                  </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-[var(--text-primary)] placeholder-neutral-gray/50 focus:outline-none focus:border-accent-neon transition-colors resize-none"
